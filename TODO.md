...
- [x] **#58 Envelope (instance-level) status extension** `[Imp 7 / Cx 3 / Debt 5]` — **Landed 2026-05-07.** Extend `CaseInstance.status` with first-class `declined | voided | expired` discriminators. Companions to #30: #30 is task-level, #58 is instance-level.
