...
**Spec anchor:** [architecture-review-handoff.md §4.4](../archive/reviews/2026-04-16-architecture-review-handoff.md) — split release trains by layer. Tool selection (Changesets + tags) resolved in [open questions Q3](../reviews/2026-04-16-architecture-review-open-questions.md#q3-release-versioning-tool-of-choice--independent-tags-per-layer-or-a-monorepo-release-manifest).
