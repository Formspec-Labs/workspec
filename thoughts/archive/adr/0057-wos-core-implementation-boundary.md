...
- WOS Runtime Companion, `specs/companions/runtime.md` — implements the runtime behavioral contracts defined in this ADR (Alternative 3 is no longer deferred)
- WOS TODO, `TODO.md` — actionable work items derived from this ADR's normative additions and architecture
- WOS Verification Matrix, `LINT-MATRIX.md` — 187 normative constraints with tier assignments
