...
**Consolidated backlog** (§6.10 items, Phase 1 assumptions, publication/schema decisions, ledger gaps, protocol edge cases): [`thoughts/plans/2026-04-11-phase11-coprocessor-open-backlog.md`](../../../thoughts/plans/2026-04-11-phase11-coprocessor-open-backlog.md) *(in the parent Formspec repo).*
