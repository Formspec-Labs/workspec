...
1. ~~**Inside `wos-spec/crates/wos-synth/`.**~~ Tight coupling to the other crates. Share workspace, share CI, share versioning. The LLM-authoring harness ships with the spec; anyone who has the spec can try it. *(Rejected: no explicit extraction path means "extract later" becomes "extract never.")*
