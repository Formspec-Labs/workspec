...
Net Stage-3 Studio schemas: **15** (1 common library + 14 entity/document schemas, from ~33 naive entities). Studio composes WOS structural truth via `$ref` only where authoritative $defs exist; documents projection target via `wosTarget` + `wosShapeRef` everywhere else.
...
- Sibling product (runtime case-management UI): [`../case-portal/README.md`](../case-portal/README.md) (renamed 2026-05-02 from `studio/`).
