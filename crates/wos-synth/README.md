...
See `thoughts/plans/2026-04-16-wos-synth-crate.md` for the rewritten §5.4 plan and `thoughts/plans/2026-04-17-wos-authoring-crate.md` / `thoughts/plans/2026-04-17-wos-mcp-crate.md` for the two new authoring-stack plans this split aligns with.
