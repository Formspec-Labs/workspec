...
use super::{AuthContext, AuthProvider, AuthResult, AuthUser, TokenPair};

/// Always authenticates as a fixed user. Used by tests and by the offline
/// demo (`WOS_AUTH=mock`) to preserve the studio's Jane Doe experience.
pub struct MockAuth {
    user: AuthUser,
    jti: String,
}
