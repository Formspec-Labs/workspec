...
//! Typed model for WOS Business Calendar Config sidecars.
//!
//! Deserialized from JSON via serde. Business calendar sidecars target
//! a kernel workflow and provide business-day, holiday, and operating-hours
//! data consumed by governance processors for SLA evaluation (Governance
//! S10.3) and temporal parameter resolution (Governance S13.3).
