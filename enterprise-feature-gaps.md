...
**Critical dependency: Formspec Coprocessor implementation.** The handoff protocol between Formspec form submissions and WOS case instances is now specified in Runtime Companion S15. The remaining dependency is implementing that protocol in the SaaS layer so the platform does not invent a divergent submission-to-case bridge.
