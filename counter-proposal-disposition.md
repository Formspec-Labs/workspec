...
| FP-05 | AI generation is a first-class constraint | HELD | Spec → schema → lint → conformance loop. **WOS:** use `work-spec/README.md` / `RELEASE-STREAMS.md` for current schema-stream and lint counts (repo numbers move; older “18 / 116” snapshots are not normative). |
